...
- [ ] T010 Define layered boundaries (UI/API/agent/memory) and enforce service/domain ownership
...
- [ ] T015 [P] [US1] Backend service unit tests in tests/unit/test_[service].py
- [ ] T016 [P] [US1] AI prompt/personality regression test in tests/regression/test_[persona].py
...
- [ ] T023 [US1] Enforce streaming response behavior where AI output is involved
- [ ] T024 [US1] Connect MemoryService retrieval/write path where user context is required
- [ ] T025 [US1] Enforce per-user memory scoping by authenticated user ID in queries and writes
...
- [ ] T027 [P] [US2] Backend service unit tests in tests/unit/test_[service].py
...
- [ ] T034 [P] [US3] Backend service unit tests in tests/unit/test_[service].py
...
- Tests MUST be written and FAIL before implementation for applicable scope
